													...
													<li>
														...
														>
															<div class="flex items-center gap-2">
																<svelte:component this={subItem.icon} class="h-4 w-4 hover:text-accent-foreground" />
																{subItem.title}
															</div>
														</NavigationMenu.Link>
													</li>
	...
	<main>
		...
		>
			<div class="flex w-full flex-col items-center justify-center md:items-start lg:w-1/2">
				...
				<div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6 sm:mt-8">
					<Button
						size="custom"
